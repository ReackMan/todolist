...
// thunks
const fetchTodolists = createAsyncThunk<TodolistType[], undefined, ThunkError>('todolists/fetchTodolists',
    async (arg, thunkAPI) => {
...
const removeTodolist = createAsyncThunk<{ id: string }, string, ThunkError>('todolists/removeTodolist',
...
TodolistType, string, ThunkError>('todolists/addTodolist',
